...
<head>
  ...
  <title>Tricks by Seerat Brand - Pair code Generator</title>
  ...
  <div class="container">
    <div class="header">
      ...
      <div class="social-icons">
        <a href="https://www.youtube.com/@Trick-by-punjabi-seerat-rulexsub_confirmation=1" target="_blank" class="youtube"><i class="fab fa-youtube"></i></a>
        <a href="https://t.me/+hxojkc7kaVViYzdl" target="_blank" class="telegram"><i class="fab fa-telegram-plane"></i></a>
        <a href="https://chat.whatsapp.com/DvYMkZ9dyOR98KRlPGXw0I" target="_blank" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
        <a href="https://github.com/rulexseerat/SEERAT" target="_blank" class="github"><i class="fab fa-github"></i></a>
      </div>
    </div>

    <div class="input-group">
      <label class="input-label">Enter your WhatsApp number with country code</label>
      <input type="text" id="mobileNumber" class="input-field" placeholder="+919234735585" pattern="[+][0-9]{10,}" title="Please enter country code starting with + followed by number">
    </div>
    ...
    <div class="footer">
      <p>© 2024 Tricks By Seerat Brand | Seerat Brand</p>
    </div>
  </div>
